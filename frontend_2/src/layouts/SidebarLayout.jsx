...
const SidebarLayout = ({ children }) => {
    ...
    return (
        <div className="flex h-screen bg-gray-950 text-gray-100 font-sans overflow-hidden">
            ...
            {/* Main Content */}
            <main className="flex-1 overflow-y-auto relative flex flex-col bg-gray-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-950 to-gray-950">
                {children}
            </main>
        </div>
    )
